...
<div class="form-card">
    <h2>Tambah Jenis Disabilitas Baru</h2>
    ...
    <form action="<?= site_url('admin/jenis-disabilitas/create/') ?>" method="post">
        <?= csrf_field() ?>
        <div class="form-group">
            <label for="nama_jenis">Nama Jenis <span class="required-star">*</span></label>
            <input type="text" name="nama_jenis" class="form-input" placeholder="Contoh: Tunanetra" value="<?= old('nama_jenis') ?>" required>
        </div>
        <div class="form-group">
            ...
            <select name="golongan" class="form-input" required>
                ...
                <option value="Disabilitas Fisik" <?= old('golongan') == 'Disabilitas Fisik' ? 'selected' : '' ?>>Disabilitas Fisik</option>
                <option value="Disabilitas Sensorik" <?= old('golongan') == 'Disabilitas Sensorik' ? 'selected' : '' ?>>Disabilitas Sensorik</option>
                <option value="Disabilitas Mental" <?= old('golongan') == 'Disabilitas Mental' ? 'selected' : '' ?>>Disabilitas Mental</option>
                <option value="Disabilitas Intelektual" <?= old('golongan') == 'Disabilitas Intelektual' ? 'selected' : '' ?>>Disabilitas Intelektual</option>
            </select>
        </div>
